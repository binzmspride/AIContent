  ...
  vi: {
    common: {
      ...
      apiKeys: {
        ...
        create: "Tạo khóa API",
        createTitle: "Tạo khóa API mới",
        createDescription: "Tạo khóa API để tích hợp với các ứng dụng bên thứ ba.",
        createButton: "Tạo khóa",
        nameLabel: "Tên khóa API",
        namePlaceholder: "Ví dụ: Khóa cho WordPress",
        scopesLabel: "Quyền truy cập",
        scopeUserRead: "Đọc thông tin người dùng",
        scopeArticlesRead: "Đọc danh sách bài viết",
        scopeCreditsRead: "Đọc số dư tín dụng",
        keyCreatedTitle: "Đã tạo khóa API thành công",
        keyCreatedDescription: "Vui lòng lưu thông tin khóa API. Bạn sẽ không thể xem lại mã bí mật sau khi đóng cửa sổ này.",
        securityWarningTitle: "Thông tin bảo mật quan trọng",
        securityWarningDescription: "Khóa bí mật này chỉ được hiển thị MỘT LẦN. Hãy lưu lại ở nơi an toàn. Nếu mất khóa, bạn sẽ cần tạo mới.",
        apiKeyLabel: "Khóa API",
        secretLabel: "Mã bí mật",
        closeButton: "Đóng",
        listTitle: "Danh sách khóa API",
        listDescription: "Quản lý các khóa API để tích hợp với ứng dụng bên thứ ba.",
        noKeys: "Chưa có khóa API nào. Hãy tạo khóa đầu tiên.",
        tableColumnName: "Tên",
        tableColumnKey: "Khóa API",
        tableColumnScopes: "Quyền truy cập",
        tableColumnStatus: "Trạng thái",
        tableColumnLastUsed: "Sử dụng lần cuối",
        tableColumnCreated: "Ngày tạo",
        ...
        delete: "Xóa",
        docsLink: "Tài liệu API đầy đủ có sẵn tại",
  ...
  en: {
    ...
    common: {
      ...
      apiKeys: {
        ...
        createDescription: "Generate API keys to integrate with third-party applications.",
        createButton: "Create Key",
        nameLabel: "API Key Name",
        namePlaceholder: "Example: WordPress Integration",
        scopesLabel: "Scopes",
        scopeUserRead: "Read user information",
        scopeArticlesRead: "Read article list",
        scopeCreditsRead: "Read credit balance",
        keyCreatedTitle: "API Key Created Successfully",
        keyCreatedDescription: "Please save your API key information. You will not be able to view the secret again after closing this dialog.",
        securityWarningTitle: "Important Security Information",
        securityWarningDescription: "This secret is shown ONLY ONCE. Store it securely. If lost, you will need to create a new key.",
        apiKeyLabel: "API Key",
        secretLabel: "Secret",
        closeButton: "Close",
        listTitle: "API Keys",
        listDescription: "Manage your API keys for third-party integration.",
        noKeys: "No API keys created yet. Create your first key.",
        tableColumnName: "Name",
        tableColumnKey: "API Key",
        tableColumnScopes: "Scopes",
        tableColumnStatus: "Status",
        tableColumnLastUsed: "Last Used",
        ...
        delete: "Delete",
        docsLink: "Full API documentation available at",
        viewDocs: "View Docs"
      },
