...
export const appConfig = {
  ...
  name: process.env.APP_NAME || 'SEO Content Generator',
  emailFromName: process.env.EMAIL_FROM_NAME || 'SEO Content Generator',
...
let smtpConfig = {
  ...
  from: process.env.EMAIL_FROM ? (process.env.EMAIL_FROM_NAME ? `${process.env.EMAIL_FROM_NAME} <${process.env.EMAIL_FROM}>` : process.env.EMAIL_FROM) : ''
};
