...
- June 18, 2025: Fixed image display in social media content editing - created API endpoint to fetch article-associated images, updated frontend to load images through database relationships instead of markdown links, changed "Hình ảnh đã chọn" to "Hình ảnh được chọn" as requested, ensuring selected images display properly in edit interface
