...
- June 27, 2025: Simplified reference sources input in content creation page - changed from multi-line textarea to single URL input field as requested by user. Users can now only enter one reference link instead of multiple links.
