...
- June 20, 2025: Enhanced scheduled posts interface with article image preview - added image gallery display when selecting articles for scheduled posts, showing up to 4 images in 2x2 grid with #132639 background theme consistency. Improved Facebook publishing with direct image upload functionality instead of URL sharing, supporting both featuredImage and imageUrls fields with proper fallback mechanisms.
